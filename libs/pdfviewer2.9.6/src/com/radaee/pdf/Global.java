...
import com.radaee.privateKeys.AgitivePrivateKeys;
...
public class Global {
	...
	public static void Init(Activity act)
	{
		...
		boolean succeeded = activeStandard(act, AgitivePrivateKeys.COMPANY,
				AgitivePrivateKeys.EMAIL, AgitivePrivateKeys.SERIAL);
