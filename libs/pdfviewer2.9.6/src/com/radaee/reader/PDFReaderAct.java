...
{
	public static final String CURRENT_PAGE_NUMBER_KEY = "currentPageNumber";
    ...
    public void onCreate(Bundle savedInstanceState)
    {
		...
		m_doc.Open(getFilesDir() + "/" + fileName, null);
		m_reader.PDFOpen(m_doc, false, this);
		if (savedInstanceState != null && savedInstanceState.containsKey(PDFReaderAct.CURRENT_PAGE_NUMBER_KEY)) {
			m_reader.PDFGotoPage(savedInstanceState.getInt(PDFReaderAct.CURRENT_PAGE_NUMBER_KEY, 0));
		}
    ...
    protected void onSaveInstanceState(Bundle savedInstanceState) {
    	savedInstanceState.putInt(PDFReaderAct.CURRENT_PAGE_NUMBER_KEY, this.m_reader.getPageNubmer());
    }
